...
class CardDisplay extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    double _cardwidth = screenWidth - 50;
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              if (shotCard.fileName != null)
                //getAlign("assets/images/" + shotCard.fileName)
  ...
  Align getAlign(String path) {
    return Align(alignment: Alignment.bottomCenter, child: Image.asset("path"));
  }
}
